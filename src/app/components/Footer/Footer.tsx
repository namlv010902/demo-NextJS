      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
          <div className="grid grid-cols-1 gap-x-8 gap-y-6 text-base font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-10">
            <a href="#" className="hover:text-gray-300">Open roles <span aria-hidden="true">&rarr;</span></a>
            <a href="#" className="hover:text-gray-300">Internship program <span aria-hidden="true">&rarr;</span></a>
            <a href="#" className="hover:text-gray-300">Our values <span aria-hidden="true">&rarr;</span></a>
            <a href="#" className="hover:text-gray-300">Meet our leadership <span aria-hidden="true">&rarr;</span></a>
          </div>
